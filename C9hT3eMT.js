import{D as l,J as d,z as o,H as i,G as c,al as g,aJ as m,cs as b,cH as f,bC as $,cE as h,x as y,bP as a}from"./9ge5YqQ_.js";const t="0!important",p="-1px!important";function s(r){return i(`${r}-type`,[o("& +",[l("button",{},[i(`${r}-type`,[c("border",{borderLeftWidth:t}),c("state-border",{left:p})])])])])}function n(r){return i(`${r}-type`,[o("& +",[l("button",[i(`${r}-type`,[c("border",{borderTopWidth:t}),c("state-border",{top:p})])])])])}const x=l("button-group",`
 flex-wrap: nowrap;
 display: inline-flex;
 position: relative;
`,[d("vertical",{flexDirection:"row"},[d("rtl",[l("button",[o("&:first-child:not(:last-child)",`
 ...
 margin: ${t};
 border-radius: ${t};
 `),n("default"),i("ghost",[n("primary"),n("info"),n("success"),n("warning"),n("error")])])])]),v={size:String,vertical:Boolean},E=g({name:"ButtonGroup",props:v,setup(r){const{mergedClsPrefixRef:e,mergedRtlRef:u}=b(r);return f("-button-group",x,e),$(y,r),{rtlEnabled:h("ButtonGroup",u,e),mergedClsPrefix:e}},render(){const{mergedClsPrefix:r}=this;return m("div",{class:[`${r}-button-group`,this.rtlEnabled&&`${r}-button-group--rtl`,this.vertical&&`${r}-button-group--vertical`],role:"group"},this.$slots)}});class G{static synchronize(){return a.get("/company/customers/synchronize")}static getList(e){return a.get("/company/customers",{params:e})}static getDetail(e){return a.get(`/company/customers/${e}`)}static update(e,u){return a.put(`/company/customers/${e}`,u)}static delete(e){return a.delete(`/company/customers/${e}`)}}export{G as C,E as N};
