...
`,[vn(),B("dropdown-option",`
 ...
 padding: var(--n-padding);
 `)])]),at={animated:{type:Boolean,default:!0},keyboard:{type:Boolean,default:!0},size:String,inverted:Boolean,placement:{type:String,default:"bottom"},onSelect:[Function,Array],options:{type:Array,default:()=>[]},menuProps:Function,showArrow:Boolean,renderLabel:Function,renderIcon:Function,renderOption:Function,nodeProps:Function,labelField:{type:String,default:"label"},keyField:{type:String,default:"key"},childrenField:{type:String,default:"children"},value:[String,Number]},dt=Object.keys(Ae),st=Object.assign(Object.assign(Object.assign({},Ae),at),ee.props),vt=U({name:"Dropdown",inheritAttrs:!1,props:st,setup(e){const n=D(!1),t=be(L(e,"show"),n),o=z(()=>{const{keyField:m,childrenField:x}=e;return Wn(e.options,{getKey(C){return C[m]},getDisabled(C){return C.disabled===!0},getIgnored(C){return C.type==="divider"||C.type==="render"},getChildren(C){return C[x]}})}),r=z(()=>o.value.treeNodes),i=D(null),a=D(null),s=D(null),d=z(()=>{var m,x,C;return(C=(x=(m=i.value)!==null&&m!==void 0?m:a.value)!==null&&x!==void 0?x:s.value)!==null&&C!==void 0?C:null}),c=z(()=>o.value.getPath(d.value).keyPath),f=z(()=>o.value.getPath(e.value).keyPath),h=Y(()=>e.keyboard&&t.value);mn({keydown:{ArrowUp:{prevent:!0,handler:S},ArrowRight:{prevent:!0,handler:g},ArrowDown:{prevent:!0,handler:_},ArrowLeft:{prevent:!0,handler:u},Enter:{prevent:!0,handler:O},Escape:l}},h);const{mergedClsPrefixRef:y,inlineThemeDisabled:P,mergedComponentPropsRef:v}=ae(e),A=z(()=>{var m,x;return e.size||((x=(m=v?.value)===null||m===void 0?void 0:m.Dropdown)===null||x===void 0?void 0:x.size)||"medium"}),N=ee("Dropdown","-dropdown",it,yn,e,y);J(se,{labelFieldRef:L(e,"labelField"),childrenFieldRef:L(e,"childrenField"),renderLabelRef:L(e,"renderLabel"),renderIconRef:L(e,"renderIcon"),hoverKeyRef:i,keyboardKeyRef:a,lastToggledSubmenuKeyRef:s,pendingKeyPathRef:c,activeKeyPathRef:f,animatedRef:L(e,"animated"),mergedShowRef:t,nodePropsRef:L(e,"nodeProps"),renderOptionRef:L(e,"renderOption"),menuPropsRef:L(e,"menuProps"),doSelect:K,doUpdateShow:I}),ve(t,m=>{!e.animated&&!m&&w()});function K(m,x){const{onSelect:C}=e;C&&Z(C,m,x)}function I(m){const{"onUpdate:show":x,onUpdateShow:C}=e;x&&Z(x,m),C&&Z(C,m),n.value=m}function w(){i.value=null,a.value=null,s.value=null}function l(){I(!1)}function u(){j("left")}function g(){j("right")}function S(){j("up")}function _(){j("down")}function O(){const m=R();m?.isLeaf&&t.value&&(K(m.key,m.rawNode),I(!1))}function R(){var m;const{value:x}=o,{value:C}=d;return!x||C===null?null:(m=x.getNode(C))!==null&&m!==void 0?m:null}function j(m){const{value:x}=d,{value:{getFirstAvailableNode:C}}=o;let p=null;if(x===null){const k=C();k!==null&&(p=k.key)}else{const k=R();if(k){let F;switch(m){case"down":F=k.getNext();break;case"up":F=k.getPrev();break;case"right":F=k.getChild();break;case"left":F=k.getParent();break}F&&(p=F.key)}}p!==null&&(i.value=null,a.value=p)}const Q=z(()=>{const{inverted:m}=e,x=A.value,{common:{cubicBezierEaseInOut:C},self:p}=N.value,{padding:k,dividerColor:F,borderRadius:V,optionOpacityDisabled:le,[W("optionIconSuffixWidth",x)]:X,[W("optionSuffixWidth",x)]:Te,[W("optionIconPrefixWidth",x)]:Be,[W("optionPrefixWidth",x)]:Ee,[W("fontSize",x)]:De,[W("optionHeight",x)]:Le,[W("optionIconSize",x)]:Ge}=p,$={"--n-bezier":C,"--n-font-size":De,"--n-padding":k,"--n-border-radius":V,"--n-option-height":Le,"--n-option-prefix-width":Ee,"--n-option-icon-prefix-width":Be,"--n-option-suffix-width":Te,"--n-option-icon-suffix-width":X,"--n-option-icon-size":Ge,"--n-divider-color":F,"--n-option-opacity-disabled":le};return m?($["--n-color"]=p.colorInverted,$["--n-option-color-hover"]=p.optionColorHoverInverted,$["--n-option-color-active"]=p.optionColorActiveInverted,$["--n-option-text-color"]=p.optionTextColorInverted,$["--n-option-text-color-hover"]=p.optionTextColorHoverInverted,$["--n-option-text-color-active"]=p.optionTextColorActiveInverted,$["--n-option-text-color-child-active"]=p.optionTextColorChildActiveInverted,$["--n-prefix-color"]=p.prefixColorInverted,$["--n-suffix-color"]=p.suffixColorInverted,$["--n-group-header-text-color"]=p.groupHeaderTextColorInverted):($["--n-color"]=p.color,$["--n-option-color-hover"]=p.optionColorHover,$["--n-option-color-active"]=p.optionColorActive,$["--n-option-text-color"]=p.optionTextColor,$["--n-option-text-color-hover"]=p.optionTextColorHover,$["--n-option-text-color-active"]=p.optionTextColorActive,$["--n-option-text-color-child-active"]=p.optionTextColorChildActive,$["--n-prefix-color"]=p.prefixColor,$["--n-suffix-color"]=p.suffixColor,$["--n-group-header-text-color"]=p.groupHeaderTextColor),$}),M=P?ge("dropdown",z(()=>`${A.value[0]}${e.inverted?"i":""}`),Q,e):void 0;return{mergedClsPrefix:y,mergedTheme:N,mergedSize:A,tmNodes:r,mergedShow:t,handleAfterLeave:()=>{e.animated&&w()},doUpdateShow:I,cssVars:P?void 0:Q,themeClass:M?.themeClass,onRender:M?.onRender}},render(){const e=(o,r,i,a,s)=>{var d;const{mergedClsPrefix:c,menuProps:f}=this;(d=this.onRender)===null||d===void 0||d.call(this);const h=f?.(void 0,this.tmNodes.map(P=>P.rawNode))||{},y={ref:kn(r),class:[o,`${c}-dropdown`,`${c}-dropdown--${this.mergedSize}-size`,this.themeClass],clsPrefix:c,tmNodes:this.tmNodes,style:[...i,this.cssVars],showArrow:this.showArrow,arrowStyle:this.arrowStyle,scrollable:this.scrollable,onMouseenter:a,onMouseleave:s};return b(Fe,ye(this.$attrs,y,h))},{mergedTheme:n}=this,t={show:this.mergedShow,theme:n.peers.Popover,themeOverrides:n.peerOverrides.Popover,internalOnAfterLeave:this.handleAfterLeave,internalRenderBody:e,onUpdateShow:this.doUpdateShow,"onUpdate:show":void 0};return b(gn,Object.assign({},bn(this.$props,dt),t),{trigger:()=>{var o,r;return(r=(o=this.$slots).default)===null||r===void 0?void 0:r.call(o)}})}});export{Sn as C,ut as V,vt as _,pt as a,kn as b,ct as c,Wn as d,xe as h,ft as r,ht as s,mn as u};
